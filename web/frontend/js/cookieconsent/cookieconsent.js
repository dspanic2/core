            ...
            function () {
                ...
                _createClass(Interface, [{
                    ...
                    value: function buildModal() {
                        ...
                        return (0, _redom.el)('div#cconsent-modal', (0, _redom.el)('div.ccm__content', (0, _redom.el)('div.ccm__content__heading', (0, _redom.el)('div.cookie-title', _Language.default.getTranslation(window.CookieConsent.config, window.CookieConsent.config.language.current, 'modalMainTitle')), (0, _redom.el)('p', str2dom(_Language.default.getTranslation(window.CookieConsent.config, window.CookieConsent.config.language.current, 'modalMainText')), window.CookieConsent.config.modalMainTextMoreLink ? (0, _redom.el)('a', {
