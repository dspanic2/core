...
class MultivalueTextareaStoreField extends AbstractField implements FieldInterface
{
    ...
    public function setEntityValueFromArray(array $array)
    {
        if (isset($array[$this->attribute->getAttributeCode()])) {
            if (is_array($array[$this->attribute->getAttributeCode()])) {
                $array[$this->attribute->getAttributeCode()] = $this->cleanArray($array[$this->attribute->getAttributeCode()]);
            }
