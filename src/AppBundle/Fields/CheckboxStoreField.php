...
class CheckboxStoreField extends AbstractField implements FieldInterface
{
    ...
    public function GetFormFieldHtml()
    {
        ...
        return $this->twig->render($this->GetFormTemplate(), array('attribute' => $this->GetAttribute(), 'value' => $this->GetFormFormattedValue(), 'formType' => $this->GetFormType(), 'entity_id' => $this->entity->getId(), 'stores' => $stores));
    }
