...
var yadcf = (function ($) {
    ...
    var tablesDT = {},
        ...
        placeholderLang = {
            'select': translations.select_value,
            'select_multi': translations.select_values,
            'filter': translations.type_to_filter,
            'range': [translations.sfrom, translations.sto],
            'date': translations.select_a_date
        },
        settingsMap = {};
...
*/
    ...
    function init(oTable, options_arg, params) {
        ...
        if (instance.selector === undefined || instance.selector == '') {
