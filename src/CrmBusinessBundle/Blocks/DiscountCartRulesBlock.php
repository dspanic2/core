...
class DiscountCartRulesBlock extends AbstractBaseBlock
{
    ...
    {
        /** @var DiscountCartRuleEntity $entity */
        ...
        $this->pageBlockData["existing_attribute_fields"] = $productAttributeFilterRulesManager->getRenderedExistingAttributeFields($entity->getRules());
