...
class PaymentTypeRulesBlock extends AbstractBaseBlock
{
    ...
    {
        /** @var PaymentTypeRuleEntity $paymentTypeRule */
        $paymentTypeRule = $this->pageBlockData["model"]["entity"];
        ...
        $this->pageBlockData["existing_attribute_fields"] = $productAttributeFilterRulesManager->getRenderedExistingAttributeFields($paymentTypeRule->getRules());
