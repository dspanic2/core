...
class ProductExportRulesBlock extends AbstractBaseBlock
{
    ...
    public function GetPageBlockData()
    {
        ...
        $productExportRule = $this->pageBlockData["model"]["entity"];
        ...
        $this->pageBlockData["existing_attribute_fields"] = $productAttributeFilterRulesManager->getRenderedExistingAttributeFields($productExportRule->getRules());
