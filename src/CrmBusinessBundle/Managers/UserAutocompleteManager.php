...
class UserAutocompleteManager extends AbstractAutocompleteManager
{
    ...
    public function getAutoComplete($term, $attribute, $formData)
    {
        ...
        $sortFilters->addSortFilter(new SortFilter("fullName", "asc"));
    ...
    public function renderTemplate($data, $template, $attribute)
    {
        ...
        if (!empty($data)) {
            foreach ($data as $key => $d) {
                $ret[$key]["id"] = $d->getId();
                $ret[$key]["html"] = $this->twig->render("CrmBusinessBundle:AutocompleteTemplates:user.html.twig", array('field_data' => $d, 'attribute' => $attributeCode));
            }
        }
    ...
    {
        $ret["id"] = $item->getId();
        $ret["lookup_value"] = $this->twig->render("CrmBusinessBundle:AutocompleteTemplates:user.html.twig", array('field_data' => $item, 'attribute' => $attributeCode));
    ...
    {
        return "CrmBusinessBundle:AutocompleteTemplates:user.html.twig";
    }
    ...
    {
        return "CrmBusinessBundle:AutocompleteTemplates:user_added_entities.html.twig";
    }
}
