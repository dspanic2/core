...
class BlogCategoryListener implements ContainerAwareInterface
{
     ...
     * @return mixed
     */
    public function onBlogCategoryPreSetCreated(EntityPreSetCreatedEvent $event)
    {
        $entity = $event->getEntity();
        $data = $event->getData();

        if ($entity->getEntityType()->getEntityTypeCode() == "blog_category") {
     ...
     */
    public function onBlogCategoryPreCreated(EntityPreCreatedEvent $event)
    {
        ...
        if ($entity->getEntityType()->getEntityTypeCode() == "blog_category") {
            ...
            if (empty($entity->getTemplateType())) {
                ...
                $templateType = $this->templateManager->getTemplateTypeByCode("blog_category");
     ...
     */
    public function onBlogCategoryCreated(EntityCreatedEvent $event)
    {
        $entity = $event->getEntity();
     ...
     * @return mixed
     */
    public function onBlogCategoryPreSetUpdated(EntityPreSetUpdatedEvent $event)
    {
        $entity = $event->getEntity();
        $data = $event->getData();
     ...
     * @param EntityCreatedEvent $event
     */
    public function onBlogCategoryUpdated(EntityUpdatedEvent $event)
    {
        $entity = $event->getEntity();
     ...
     */
    public function onBlogCategoryDeleted(EntityDeletedEvent $event)
    {
        /** @var BlogCategoryEntity $entity */
        $entity = $event->getEntity();
