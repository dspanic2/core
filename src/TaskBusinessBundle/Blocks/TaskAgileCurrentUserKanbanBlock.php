...
class TaskAgileCurrentUserKanbanBlock extends AbstractBaseBlock
{
    ...
    public function GetPageBlockData()
    {
        ...
        $this->pageBlockData["model"]["users"] = [$this->helperManager->getCurrentCoreUser()];

        $tasks = $this->taskManager->getKanbanTasks($currentUser);
