                    ...
                    ->children()
                        ->arrayNode('confirmation')
                            ...
                            ->children()
                                ...
                                ->scalarNode('template')->defaultValue('FOSUserBundle:Registration:reset_password.html.twig')->end()
                                ->arrayNode('from_email')
                                    ->canBeUnset()
                                    ->children()
                ...
                ->arrayNode('resetting')
                    ...
                    ->children()
                        ...
                        ->arrayNode('email')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('template')->defaultValue('FOSUserBundle:Resetting:reset_password.html.twig')->end()
                                ->arrayNode('from_email')
                                    ->canBeUnset()
                                    ->children()
                                        ->scalarNode('address')->isRequired()->cannotBeEmpty()->end()
