...
class FOSUserExtensionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testUserLoadConfirmationEmailWithDefaults()
    {
        ...
        $this->assertParameter('FOSUserBundle:Registration:reset_password.html.twig', 'fos_user.registration.confirmation.template');
        $this->assertParameter('FOSUserBundle:Resetting:reset_password.html.twig', 'fos_user.resetting.email.template');
